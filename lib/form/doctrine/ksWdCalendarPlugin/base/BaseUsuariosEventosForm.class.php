...
/**
 * UsuariosEventos form base class.
 *
 * @method UsuariosEventos getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseUsuariosEventosForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('usuarios_eventos[%s]');

...
/**
 * UsuariosEventos filter form base class.
 *
 ...
 */
abstract class BaseUsuariosEventosFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('usuarios_eventos_filters[%s]');

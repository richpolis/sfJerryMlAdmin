 ...
 * @method sfGuardUser           setEventos()               Sets the current record's "Eventos" collection
 * @method sfGuardUser           setPrecotizaciones()       Sets the current record's "Precotizaciones" collection
...
abstract class BasesfGuardUser extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('color', 'varchar', 30, array(
             'type' => 'varchar',
             'notnull' => false,
             'default' => '',
             'length' => 30,
    ...
    public function setUp()
    {
        ...
        $this->hasMany('EventosUsuarios as Eventos', array(
             'local' => 'id',
             'foreign' => 'user_id'));

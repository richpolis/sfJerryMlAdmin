...
class sfGuardChangeUserPasswordForm extends BasesfGuardChangeUserPasswordForm {
    ...
    public function configure() {
        $this->widgetSchema['password'] = new sfWidgetFormInputPassword(array(), array('class' => 'input required'));
        $this->widgetSchema['password_again'] = new sfWidgetFormInputPassword(array(), array('class' => 'input required'));
    }

...
$(document).ready(function() {     
  ...
  $("#faddbtn").click(function(e) {
    ...
    <?php if($sf_user->getCalendarTalentoId()>0): ?>
       var usuario='<?php echo $sf_user->getCalendarTalentoId();?>';
    <?php else:?>
       var usuario='0';
    <?php endif; ?>
      crearEvento(usuario);  
  ...
  $( "#dialog-form-evento" ).dialog({
    ...
    function crearEvento(TalentoId){
        overlay.show();
        $('#dialog-form-evento').attr('talento-id',TalentoId);
        $.get('<?php echo url_for('ksWdCalendar/newAjax')?>',{talento_id: TalentoId},function(data){
    ...
    function editarEvento(variables){
        ...
        $.get('<?php echo url_for('ksWdCalendar/editAjax')?>'+variables,{},function(data){
            $('#dialog-form-evento').html(data).dialog('open');
            overlay.hide();

...
<div id="formContacto" style="margin-left: 0px;">
    ...
    <div class="formRow">
        <table border="0">
            <tr>
                <td>
        <label for="contact_name"><?php echo __('Nombre');?><span class="star">*</span>:</label>
        <br/>
    ...
    <div class="formRow">
        <table border="0">
            <tr>
                <td>
        <label for="contact_email"><?php echo __('Email');?><span class="star">*</span>:</label>
        <br/>
    ...
    <div class="formRow">
        <table border="0">
            <tr>
                <td>
        <label for="contact_subject"><?php echo __('Asunto');?>:</label>
        <br/>
    ...
    <div class="formRow">
        <table border="0">
            <tr>
                <td>
        <label for="contact_telefon"><?php echo __('Telefono');?>:</label>
        <br/>
        <?php echo $form['telefon']->render(array('class' => 'textField'))?>
        </td>
        <td>
                <?php if ($form['telefon']->hasError()): ?>
          <span class="errorIcon">
              <span class="errorTip" style="left: 30px; display: none; opacity: 1; ">
                    <?php echo $form['telefon']->getError();?>
               </span>
          </span>  
        <?php endif; ?>
        </td>
    ...
    <div class="formRow">
        <table border="0">
            <tr>
                <td>
        <label for="contact_pais"><?php echo __('País');?>:</label>
        <br/>
        <?php echo $form['pais']->render(array('class' => 'textField'))?>
        </td>
        <td>
                <?php if ($form['pais']->hasError()): ?>
          <span class="errorIcon">
              <span class="errorTip" style="left: 30px; display: none; opacity: 1; ">
                    <?php echo $form['pais']->getError();?>
               </span>
          </span>  
        <?php endif; ?>
        </td>
    ...
    <div class="formRow">
        <table border="0">
            <tr>
                <td>
        <label for="contact_message"><?php echo __('Mensaje');?><span class="star">*</span>:</label>
        <br/>
    ...
    <div class="formRow">
       <table boder="0">
        ...
        <td></td>
        <td>
        <input type="image" value="<?php echo __('Enviar');?>" src="/images/jerryml/contacto/btn_enviar.png" id="submit" style="padding: 0; width: 400px;position:relative; left: -10px;"/>
...
$(function($){
    ...
    form.find('input[type=image]').click(handleFormSubmit);

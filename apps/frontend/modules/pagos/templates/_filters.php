    ...
    <table cellspacing="0"  style="width: 100%;">
      <tfoot>
        <tr>
          <td colspan="2">
            ...
            <?php echo link_to(__('Limpiar', array(), 'sf_admin'), 'cotizaciones_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post')) ?>
      ...
      <tbody>
        ...
        <?php if ((isset($form[$name]) && $form[$name]->isHidden()) || (!isset($form[$name]) && $field->isReal())) continue ?>
          <?php include_partial('cotizaciones/filters_field', array(
            'name'       => $name,
